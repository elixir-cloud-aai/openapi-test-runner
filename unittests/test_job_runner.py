...
SCHEMA_PATH = "../tests/template/test_template_schema.json"
YAML_TEST_PATH = os.path.join(os.getcwd(), "data", "run_job_tests")
YAML_TEST_PATH_SUCCESS = os.path.join(os.getcwd(), "data", "run_job_tests", "success_01.yml")
YAML_TEST_PATH_INVALID = os.path.join(os.getcwd(), "data", "run_job_tests", "invalid_yaml.yml")
YAML_TEST_PATH_SKIP = os.path.join(os.getcwd(), "data", "run_job_tests", "skip_01.yml")
...
class TestJobRunner(unittest.TestCase):
    ...
    def test_validate_job_success(self, mock_os):
        with open("data/tests/success_service_info.yml", "r") as f:
    ...
    def test_validate_job_failure(self, mock_os):
        with open("data/tests/wrong_schema_yaml.yml", "r") as f:
            yaml_data = yaml.safe_load(f)
    ...
    def test_validate_yaml_failure(self):
        with open("data/tests/invalid_yaml.yml", "r") as f:
            with self.assertRaises(ComplianceException):
                job_runner_object = JobRunner("")
